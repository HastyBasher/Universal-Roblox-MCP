...
1. **Download the plugin:**
   - The plugin is included in this repository at `studio-plugin/MCPPlugin.rbxmx`
...
1. **Copy the plugin code:**
   - The plugin source code is included in this repository at `studio-plugin/MCPPlugin.rbxmx`
   - You can import the plugin directly into Studio
